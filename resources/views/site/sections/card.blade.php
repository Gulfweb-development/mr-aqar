        ...
        <div class="border p-2 overflow-hidden card-height">
            <div class="row mb-2">
                ...
                <div class="col-sm-10 w-sm4/5 p-0 w-100">
                    <div class="d-flex">
                        <div class="w-100">
                            <h2 class="text-md mb-2 sm:width-110"  :class="card.advertising_type === 'premium' ? 'text-white' : ''" v-text="`${purpose_lang[card.purpose]} ${card.venue.title_{{app()->getLocale()}} } {{__('in')}} ${card.area.name_{{app()->getLocale()}} }`"></h2>
                            ...
                            <span class="mdc-button mdc-button--outlined small-button d-none sm-show-button text-decoration-none text-sm"  :class="card.advertising_type === 'premium' ? 'mdc-button--outlined-white' : ''" style="padding: 10px 15px;background: white ">
