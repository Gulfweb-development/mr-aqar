...
<body class="mdc-theme--background">
   ...
   d-inline-block d-lg-none                      style="{{Route::currentRouteName() == 'companies' ? 'background-color: var(--mdc-theme-primary); color: #fff;' : ''}}">
    ...
    <header class="toolbar-1 {{ ($header ?? '') !== 'transparent' ?: 'has-bg-image' }}"
                            ...
                            <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical"
                                ...
                                <li>
                                    <a href="{{ route('Main.buyPackage',app()->getLocale()) }}" class="mdc-list-item"
                                        ...
                                        buypackage") background-color: var(--mdc-theme-primary); color: white; @endif">
                                ...
                                <li>
                                    <a href="{{ route('Main.paymentHistory',app()->getLocale()) }}"
                                        ...
                                        style="@if(collect(request()->segments())->last() == " paymenthistory")
                                        background-color: var(--mdc-theme-primary); color: white; @endif">
                                ...
                                <li>
                                    <a href="{{ route('Main.changePassword',app()->getLocale()) }}"
                                        class="mdc-list-item" role="menuitem"
                                        style="@if(collect(request()->segments())->last() == " changepassword")
                                        background-color: var(--mdc-theme-primary); color: white; @endif">
